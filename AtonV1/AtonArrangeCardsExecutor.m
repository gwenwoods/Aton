...
-(int*) handleCase:(int) caseEnum {
    ...
    switch (caseEnum) {
        ...
        case CASE_3334:
            outputCardArray = [self handle_3334];
            break;
        
        case CASE_3332:
            outputCardArray = [self handle_3332];
            break;
        
        case CASE_3331:
            outputCardArray = [self handle_3331];
            break;
        ...
        case CASE_3311:
            outputCardArray = [self handle_3311];
            break;
            
        case CASE_3342:
            outputCardArray = [self handle_3342];
            break;
            
        case CASE_3341:
            outputCardArray = [self handle_3341];
            break;
            
        case CASE_3321:
            outputCardArray = [self handle_3321];
            break;
        ...
        case CASE_2224:
            outputCardArray = [self handle_2224];
            break;
        ...
        case CASE_2243:
            outputCardArray = [self handle_2243];
            break;
            
        case CASE_2241:
            outputCardArray = [self handle_2241];
            break;
        ...
        case CASE_1114:
            outputCardArray = [self handle_1114];
            break;
            
        case CASE_1113:
            outputCardArray = [self handle_1113];
            break;
        ...
        case CASE_1143:
            outputCardArray = [self handle_1143];
            break;
            
        case CASE_1142:
            outputCardArray = [self handle_1142];
            break;
            
        case CASE_1132:
            outputCardArray = [self handle_1132];
            break;
...
-(int*) handle_3334 {
    ...
    if (t3RedCount_BlueGrey >= 2 && peepDiff[TEMPLE_3] <3) {
        outputCardArray[0] = 3;
        outputCardArray[1] = 4;
        outputCardArray[2] = 3;
        outputCardArray[3] = 3;
...
-(int*) handle_3342 {
    ...
    } else if (t4BlueOccupiedEnum == OCCUPIED_RED){
        outputCardArray[0] = 2;
        outputCardArray[1] = 3;
        outputCardArray[2] = 4;
        outputCardArray[3] = 3;
...
-(int*) handle_3321 {
    ...
    NSMutableArray *templeArray = para.templeArray;
    int t3RedCount_BlueGrey = [[templeArray objectAtIndex:TEMPLE_3] findBlueAndGreyNumForOccupiedEnum:OCCUPIED_RED];
    int t3EmptyNum = [[templeArray objectAtIndex:TEMPLE_3] findEmptySlotsNum];
    int t1EmptyNum = [[templeArray objectAtIndex:TEMPLE_1] findEmptySlotsNum];
    ...
    } else if (t3EmptyNum >= 3){
        outputCardArray[0] = 1;
        outputCardArray[1] = 2;
        outputCardArray[2] = 3;
        outputCardArray[3] = 3;
        
    } else if (t1EmptyNum >= 3){
        outputCardArray[0] = 3;
        outputCardArray[1] = 2;
        outputCardArray[2] = 1;
        outputCardArray[3] = 3;
